...
Процедура ПриНачалеРаботыСистемы()
	...
	Парам = мз_ОбщегоНазначения.ПолучитьПараметрыРаботыПользователя(); 
	Если Парам.СоздатьПользователя Тогда
		ОткрытьФорму("Справочник.Пользователи.Форма.ФормаЭлемента",Новый структура("Перезапуск",Истина));
	Иначе
		Если Парам.РабочийСтолАдминистратора Тогда
			ОткрытьФорму("ОбщаяФорма.мз_РабочийСтолАдминистратора");
		Иначе	
			ОткрытьФорму("Документ.мз_Задачи.ФормаСписка",Новый структура("Клиент",Истина));
		КонецЕсли;
	КонецЕсли;
