...
Процедура ЗаполнитьДерево(Копирование = Ложь,ПользовательИсточникКопирования = Неопределено)
	...
	Запрос.Текст ="ВЫБРАТЬ
	              ...
	              |	ПраваИНастройки.Родитель КАК Родитель
	              |ИЗ
	              |	ПланВидовХарактеристик.мз_ПраваИНастройки КАК ПраваИНастройки
	              |		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.мз_НастройкиПользователей КАК НастройкиПользователей
...
Процедура ЗаписатьНастройки()
	...
	Набор = РегистрыСведений.мз_НастройкиПользователей.СоздатьНаборЗаписей();
...
Процедура ОткрытьСписокНастроек(Команда)
	ОткрытьФорму("ПланВидовХарактеристик.мз_ПраваИНастройки.ФормаСписка");
КонецПроцедуры
