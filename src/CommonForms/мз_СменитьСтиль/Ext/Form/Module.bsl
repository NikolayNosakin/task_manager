...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		ТекущийМасштаб = мз_ОбщегоНазначения.ПолучитьНастройкуПользователя(Пользователи.ТекущийПользователь(),"МасштабФорм");		
...
Процедура СохранитьСхему()
	...
	мз_ОбщегоНазначения.УстановитьНастройкуПользователя(Пользователи.ТекущийПользователь(),"Стиль",ИмяСтиля);
	мз_ОбщегоНазначения.УстановитьНастройкуПользователя(Пользователи.ТекущийПользователь(),"МасштабФорм",МасштабФорм);
